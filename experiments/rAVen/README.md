...
## My horrible frankensteining of this repo

Huge thanks to https://github.com/nots1dd/rAVen as the og I forked this from.
Not preserving git history since I cbf with submodules here, and it's just a learning experiment to see how they've used fft as I start on my own raylib/gtk learning path
